...
compact because it is part of the landing page. Use a sidebar for the
two priors and compact observation slider, and stack the two posterior
cards vertically so the embedded app remains readable without horizontal
scrolling.
