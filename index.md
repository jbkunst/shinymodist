...
After observing data, Bayes’ rule combines the likelihood and both
priors:
...
- [Bayesian normal
  model](https://jkunst.com/shinymodist/demos/normal-priors/)
...
WebAssembly compatibility is checked in CI and supported in package
releases.
