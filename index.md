...
The first version focuses on Normal, Beta, and Gamma distributions.
Examples cover basic usage, style/bslib integration, a ROC-curve
application with base R calculations, and Beta-Binomial prior
elicitation.
